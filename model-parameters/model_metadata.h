...
#define EI_CLASSIFIER_PROJECT_ID                 825113
#define EI_CLASSIFIER_PROJECT_OWNER              "shermack"
#define EI_CLASSIFIER_PROJECT_NAME               "Edge SignTalk: Real-time Sign Language Interpreter for the Deaf and Mute Community"
